...
class GameState 
{
    ...
    EnumType    m_activePhase               = Phases::Action;
    ...
    void            endPhase();
    void            beginPhase(const PlayerID & player, const EnumType & newPhase);
...
public:
    ...
    void addCard(const PlayerID & player, const CardType & type, const size_t num, const EnumType & creationMethod, const TurnType & delay, const TurnType & lifespan);
    ...
    const EnumType          getActivePhase()                                                        const;
