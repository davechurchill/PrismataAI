...
CardTypeInfo::CardTypeInfo()
    ...
    , startingCharge        (0)
    , droneBuySacCost       (0)
    , abilityAttackAmount   (0)
    , beginTurnAttackAmount (0)
    , attackGivenToEnemy    (0)
    , customHeuristicValue  (0)
    , buildTime             (1)
    , defaultBlocking       (false)
    , assignedBlocking      (false)
    , frontline             (false)
    , fragile               (false)
    , potentiallyMoreAttack (false)
    , isTech                (false)
    , isSpell               (false)
    , hasAbility            (false)
    , hasBeginOwnTurnScript (false)
    , isEconCard            (false)
    , isBaseSet             (false)
    , isAbilityHealthUserOnly(false)
    , hasCustomHeuristicValue(false)
    , targetActionType      (ActionTypes::NONE)
{
